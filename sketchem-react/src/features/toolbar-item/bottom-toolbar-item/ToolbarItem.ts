...
const toolbarItemsList: ToolbarItem[] = [
    ...
    new ToolbarItem("Clear 2", function noop() { }, function noop() { }, ["A"]),
    new ToolbarItem("Clear 3", function noop() { }, function noop() { }, ["A"]),
    new ToolbarItem(  "Clear 4", function noop() { }, function noop() { }, ["A"]),
];
