!(function (e) {
    ...
    function t(e) {
        var t = e.split(/[-|_]/);
        return { language: t[0], local: t[1] };
    }
    e || (e = {});
    var o = Kekule,
        n = Kekule.getLanguage() || (e && e.navigator ? navigator.language || navigator.browserLanguage : "en-US");
    o.language = n;
    var a = t(n),
        i = t("en-US"),
        _ = [a.language + "_" + a.local, a.language, i.language + i.local, i.language];
    (Kekule.Localization = {}), (Kekule.LocalizationRes = {});
    var r = Kekule.LocalizationRes;
    function T(e, t, o) {
        var n = o || r[e];
        return !n && t && ((n = {}), (r[e] = n)), n;
    }
    function l(e, t, o) {
        var n = T(t, !1, o);
        if (n) {
    ...
    function E(e, t, o) {
        for (var n = (t ? [t] : []).concat(_), a = 0, i = n.length; a < i; ++a) {
            var r = l(e, n[a], o);
    ...
    var I,
        O = [],
        c = !!(e || e.window).__kekuleMarkLocalizationModuleInfo__,
        d = {};
    function A(e, t, o, n) {
        if (o) {
            var a = l(t, e, n);
            (function (e, t, o, n, a) {
                var i = T(o, n, a);
                !!i && Object.setCascadeFieldValue(e, t, i, n);
            })(t, a ? Object.extendEx(a, o, { cascade: !0 }) : JSON.parse(JSON.stringify(o)), e, !0, n);
        }
    }
    (Kekule.$L = s),
        (Kekule.Localization.getLanguages = function () {
            var e = [];
            for (var t in r) e.push(t);
            return e;
        }),
        (Kekule.Localization.getValue = s),
        (Kekule.Localization.findValue = E),
        (Kekule.Localization.getModuleInfos = function () {
            return d;
        }),
        (Kekule.Localization.setCurrModule = function (e) {
            (I = e), O.indexOf(e) < 0 && O.push(e);
        }),
        (Kekule.Localization.getModuleNames = function () {
            return O;
        }),
        (Kekule.Localization.addResource = function (e, t, o) {
            (A(e, t, o), c) &&
                A(
                    e,
                    t,
                    ...
                    (function (e, t) {
                        e = e || "GLOBAL";
                        var o = Object.getCascadeFieldValue(e, d);
                        return !o && t && (o = Object.setCascadeFieldValue(e, {}, d, !0)), o;
                    })(I, !0)
                );
        });
})(this),
    ...
    Kekule.Localization.addResource("en", "Texts", { UNNAMED: "unnamed" }),
    Kekule.Localization.addResource("en", "ErrorMsg", {
        ...
        CANNOT_ADD_NON_NODE_NOR_CONNECTOR_TO_STRUCT_CONTAINER:
            "Can not add object other than node or connector to structure object container",
        ...
        JCAMP_LDR_TARGET_UNIT_NOT_MATCH_WITH_DETAIL:
            "The unit of property {0} ({1}) can not be converted to the request one ({2}) for JCAMP {3} LDR",
        FAILED_TO_ASSIGN_SYMBOL_TO_VARIABLE: "Fail to assign a symbol to variable {0}",
        JCAMP_IMPLICIT_HYDROGEN_COUNT_NOT_MATCH_DETAIL:
        ...
        THREEJS_LIB_NOT_UNAVAILABLE:
            "Three.js not available, try to include it through the <script> tag or import the module by Kekule.externalResourceManager.register method",
        THREEJS_DRAWING_NOT_UNAVAILABLE:
            "Webgl, Canvas or SVG is not supported in this browser, please upgrade to a modern one",
    ...
    Kekule.Localization.addResource("en", "ErrorCheckMsg", {
        ...
        BOND_WITH_ID_ORDER_EXCEED_ALLOWED_WITH_SUGGEST:
            "The bond order of {0} ({1}) exceeds the maximum allowed value {2}",
    ...
    Kekule.Localization.addResource("en", "ErrorMsg", {
        ...
        DRAW_BRIDGE_NOT_SUPPORTED:
            "It seems that your web browser is not modern enough to support the drawing function. Please update it.",
    ...
    Kekule.Localization.addResource("en", "OBJDEF_TEXTS", {
        ...
        Render: {
            ...
            MoleculeDisplayConfigs: {
                ...
                DES_partialChargeDecimalsLength:
                    "If an atom has a partical charge (e.g., +1.5), how many digits after decimal point should be displayed",
                TITLE_distinguishSingletAndTripletRadical: "Distinguish singlet/triplet radical",
                DES_distinguishSingletAndTripletRadical:
                    "Whether use different mark to distinguish singlet(..) and triplet(^^) radical",
            ...
            LengthConfigs: {
                ...
                DES_multipleBondSpacingRatio:
                    "Ratio of spacing between two lines in double or triple bond to bond length.",
                ...
                TITLE_glyphStickOffsetRelLength: "Glyph stick offset relative length",
            ...
            Model3DConfigs: {
                ...
                DES_multiConnectorMarginRatio:
                    "If multi-cylinder is used for multibond, ratio of margin between cylinders and radius of cylinder",
            },
            Length3DConfigs: {
        ...
        ChemWidget: {
            ...
            ChemObjDisplayerIOConfigs: {
                ...
                DES_autoGenerateCoordsAfterLoad:
                    "Whether coordinates of atoms are automatically generated when loading a molecule without explicit coordinate information",
            },
            ChemObjDisplayerEnvironmentConfigs: {
                ...
                DES_antialiasBlurRatio: "Antialias blur ratio",
            ...
            ViewerHotKeyConfigs: { TITLE_hotKeys: "Hot keys", DES_hotKeys: "Hot key and action settings" },
        },
        Editor: {
            BaseEditorConfigs: {
            ...
            InteractionConfigs: {
                ...
                DES_enableTrackOnNearest:
                    "If setting to true, hot track or selection will focus on nearest object to current position, otherwise, the topmost object around will be focused.",
                ...
                DES_autoExpandClientSizeAfterLoading:
                    "Whether expand the client size automatically after loading a large object out of boundary",
                TITLE_autoExpandClientSizeAfterManipulation: "Auto expand client size after manipulation",
                DES_autoExpandClientSizeAfterManipulation:
                    "Whether expand the client size automatically when moving a object out of the boundary of editor",
                TITLE_autoSelectNewlyInsertedObjects: "Auto select new inserted objects",
                DES_autoSelectNewlyInsertedObjects:
                    "Whether select objects newly inserted or modified in editor automatically",
                TITLE_autoSelectNewlyInsertedObjectsOnTouch: "Auto select new inserted objects in touch device",
                DES_autoSelectNewlyInsertedObjectsOnTouch:
                    "Whether select objects newly inserted or modified in editor automatically in touch device",
                TITLE_objBoundTrackMinInflation: "Object bound minimal inflation (default)",
                DES_objBoundTrackMinInflation:
                    "The default minimal inflation of the bound of object to make it easier to select",
                TITLE_objBoundTrackMinInflationMouse: "Object bound minimal inflation (mouse)",
                DES_objBoundTrackMinInflationMouse:
                    "The minimal inflation of the bound of object to make it easier to select when using mouse as pointer device",
                TITLE_objBoundTrackMinInflationTouch: "Object bound minimal inflation (touch)",
                DES_objBoundTrackMinInflationTouch:
                    "The minimal inflation of the bound of object to make it easier to select when touching on screen",
                TITLE_objBoundTrackMinInflationPen: "Object bound minimal inflation (pen)",
                DES_objBoundTrackMinInflationPen:
                    "The minimal inflation of the bound of object to make it easier to select when using pen as pointer device",
                TITLE_objBoundTrackInflationRatio: "Object bound inflation ratio (default)",
                DES_objBoundTrackInflationRatio:
                    "The default inflation ratio (compaing with the default bond length) of the bound of object to make it easier to select",
                TITLE_objBoundTrackInflationRatioMouse: "Object bound inflation ratio (mouse)",
                DES_objBoundTrackInflationRatioMouse:
                    "The inflation ratio (compaing with the default bond length) of the bound of object to make it easier to select when using mouse as pointer device",
                TITLE_objBoundTrackInflationRatioPen: "Object bound inflation ratio (pen)",
                DES_objBoundTrackInflationRatioPen:
                    "The inflation ratio (compaing with the default bond length) of the bound of object to make it easier to select when using pen as pointer device",
                TITLE_objBoundTrackInflationRatioTouch: "Object bound inflation ratio (touch)",
                DES_objBoundTrackInflationRatioTouch:
                    "The inflation ratio (compaing with the default bond length) of the bound of object to make it easier to select when touching on screen",
                TITLE_selectionMarkerInflation: "Selection marker inflation",
                DES_selectionMarkerInflation:
                    "Inflation of object selection mark, makes it easier to see the containing objects",
                ...
                TITLE_followPointerCoordOnDirectManipulatingSingleObj:
                    "Follow pointer coordinate on direct manipulating object",
                DES_followPointerCoordOnDirectManipulatingSingleObj:
                    "If true, the new coordinate of manipulating object will be set directly by the position of pointer (rather than the delta coordinate to the original position)",
                TITLE_followPointerCoordOnDirectManipulatingSingleObjDistanceThreshold:
                    "Threshold of following pointer coordinate on direct manipulating object",
                DES_followPointerCoordOnDirectManipulatingSingleObjDistanceThreshold:
                    "Threshold when following pointer coordinate on direct manipulating object",
                ...
                DES_rotationLocationPointDistanceThreshold:
                    "Rotation will occur only when mouse point distance (from rotation center) larger than this value",
                TITLE_directedMoveDistanceThreshold: "Direct move min distance",
                DES_directedMoveDistanceThreshold:
                    "Direct moving will only be done if moved distance large than this value",
                TITLE_enablePartialAreaSelecting: "Enable partial selecting",
                DES_enablePartialAreaSelecting:
                    "If this value is true, when drag a selecting rubber band, object partly in the band will be totally selected",
                ...
                DES_enableOffSelectionManipulation:
                    "When setting to true, you can still move, resize or rotate selected objects by holding mouse or touch outside selection for a while",
                ...
                DES_offSelectionManipulationActivatingTimeThreshold:
                    "The minimal time (in ms) need for holding mouse or touch to invoke off-selection manipulation",
                TITLE_selectionMarkerDefPulseDuration: "Default selection mark pulse duration",
                DES_selectionMarkerDefPulseDuration:
                    "The duration (in ms) of selection mark pulse when the selection is been emphasised",
                ...
                DES_rotationRegionInflation:
                    "User can rotate the selected objects by pressing and move mouse in this inflated region outside selection",
                TITLE_enableMergePreview: "Enable merge preview",
                DES_enableMergePreview:
                    "Whether a preview operation is used rather then the actual merge operation when merge two objects in editor during manipulation. Turn on this option may improve the performance of object manipulation.",
                TITLE_enableGestureManipulation: "Enable gesture manipulation",
                DES_enableGestureManipulation:
                    "Whether user can use touch gestures (e.g. pinch) to scale or rotate selected objects in editor",
                TITLE_enableGestureZoomOnEditor: "Enable gesture zoom on editor",
                DES_enableGestureZoomOnEditor:
                    "Whether user can use pinch gesture to zoom in or out the editor when there is no selection existed",
                TITLE_trackSimplifierDistanceThreshold: "Track-input curve simplification threshold",
                DES_trackSimplifierDistanceThreshold:
                    "Distance threshold in simplifying curve drawn by track-input tool",
                ...
                DES_trackSimplifierIgnoreSegmentThreshold:
                    "Segment length less than this threshold drawn by track-input will be ignored in parsing",
                TITLE_trackMergeDistanceThreshold: "Track-input merge distance threshold",
                DES_trackMergeDistanceThreshold:
                    "If a joint or end point of line segment drawn by track-inpu tool is close to another line segment (less than this threshold), it will be regarded on that line.",
                ...
                DES_allowUnknownAtomSymbol:
                    "Allow inputting unknown symbol and handle it as pseudo atom in atom setter",
                TITLE_clonedObjectScreenOffset: "Copied object coord offset",
                DES_clonedObjectScreenOffset:
                    "The distance between copied objects and origin objects when doing paste selection action in editor",
                TITLE_enableBondKekulizeHucklize: "Enable Kekulize and Hucklize function of bond",
                DES_enableBondKekulizeHucklize:
                    "Whether Kekulize and Hucklize buttons are shown in bond modifier of editor",
            ...
            UiMarkerConfigs: {
                ...
                DES_selectingMarkerFillColor:
                    "Fill color of selecting mark. Usually this value should be left blank (not filled)",
                ...
                DES_trackMarkerStrokeColor:
                    "Stroke color of track mark when using track-input tool to draw a structure",
                TITLE_trackMarkerStrokeWidth: "Track-input mark stroke width",
                DES_trackMarkerStrokeWidth:
                    "Stroke width of track mark when using track-input tool to draw a structure",
                ...
                DES_flexStructureAssocMarkerFontFamily:
                    "Font family of mark showing atom count of flex ring/chain tool",
                TITLE_issueCheckMarkerColors: "Issue check markers color",
                DES_issueCheckMarkerColors:
                    "Color of issue check markers, different colors are used for different issue levels",
            ...
            HotKeyConfigs: { TITLE_hotKeys: "Hot keys", DES_hotKeys: "Hot key and action settings" },
            BaseEditor: {
                ...
                DES_enableIssueCheck:
                    "Whether enable issue checker to detect errors and warning among objects in editor",
            },
            ChemSpaceEditor: {
