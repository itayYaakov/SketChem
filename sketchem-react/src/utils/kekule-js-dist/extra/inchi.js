var InChIModule = (function () {
    var _scriptDir = typeof document !== "undefined" && document.currentScript ? document.currentScript.src : undefined;
    return function (InChIModule) {
        ...
        var wasmMemory;
        var wasmTable = new WebAssembly.Table({ initial: 72, maximum: 72, element: "anyfunc" });
        var ABORT = false;
        var EXITSTATUS = 0;
        ...
        var DYNAMIC_BASE = 5336768,
            DYNAMICTOP_PTR = 93680;
        ...
        var _getInChIKeyJson = (Module["_getInChIKeyJson"] = function () {
            return Module["asm"]["m"].apply(null, arguments);
        });
        var _malloc = (Module["_malloc"] = function () {
            return Module["asm"]["n"].apply(null, arguments);
        });
        var _molToInchiJson = (Module["_molToInchiJson"] = function () {
